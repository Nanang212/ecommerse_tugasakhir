    ...
    public function shipping($origin, $idalamat)
    {
      ...
      $sumberat = DB::table("detailpemesanan")->where('no_pemesanan', $no_pemesanan)->get()->sum('berat');
        ...
        CURLOPT_SSL_VERIFYPEER => false,
  			...
  			CURLOPT_POSTFIELDS => "origin=$origin&originType=city&destination=$destination&destinationType=city&weight=1000&courier=pos:first:ninja:dse:sicepat:jet:ncs:rex:jne:tiki:jnt",
