      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Logo Footer</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form action="/footerimage/update" role="form" id="updateform" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label class="control-label col-md-6">Logo Footer<span class="required">
                  * </span>
                </label>
                <div class="col-md-4">
              ...
              <div class="form-group" id="upload_gambar_utama">
                <label class="control-label col-md-6">Logo Footer  (Rekomendasi width: 155px, height: 36px)<span class="required">
                  * </span>
                </label>
                <div class="col-md-4">
