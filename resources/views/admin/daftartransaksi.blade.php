          ...
          <div class="card-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                ->where('statustransaksi.konfirmasi_penerimaan', '=', '1')
                ->select('statuspembayaran.status_pembayaran', 'invoice.tanggal', 'invoice.jatuh_tempo', 'invoice.no_invoice', 'invoice.metode_pembayaran', 'pemesanan.no_pemesanan', 'pemesanan.pelanggan', 'pemesanan.grandtotal', 'statustransaksi.no_statustransaksi', 'statustransaksi.no_resi', 'statustransaksi.status_pengiriman')
                ->get();
                ?>
                <?php $no='1'; ?>
